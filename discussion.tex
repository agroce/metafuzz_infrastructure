...
% (e.g., new fuzzers, new transformations, new forms of feedback, new benchmarks, new ensemble methods, etc.) 
...
\noindent\textbf{Year 1:} 
 \begin{itemize}[labelwidth=0.7em, labelsep=0.6em, topsep=0ex, itemsep=0ex,
  ...
  \item Requirement elicitation (including related outreach, e.g.,
    initial workshop) (All)
  ...
  \item Significant initial progress on source-level target transformation (CMU lead,
    NAU support)
    \item Significant initial progress on universalized custom mutators (CMU lead,
  NAU support)
...
\item Continue overall work on prototype implementations and ensure
  coordination of tools (All according to respective responsibilities)
  \item Check sufficient progress on handling all paradigmatic
    problems (All according to respective responsibilities)
 \item Significant initial progress on binary target transformation (UVA lead)
  \item Continue outreach and initiate initial use by outside members
    of the fuzzing community using CloudBank (All)
    \item Integrate tools in progress with cross-cutting
...
\item Complete implementation of overall system (NAU/UVA lead)
  \item Complete implementation of source-level target transformations
    (CMU lead, NAU support)
    \ item Complete implementation of binary-level target
    transformations (UVA lead)
    \item Complete implementation of universalized custom mutators
      (NAU lead)
      \item Complete implementation and integration of domain-specific
        aspects (CMU lead, NAU/UVA support)
  \item Ensure documentation is complete and thorough, including
    examples of solved user problems (All)    
