...
\clg{I'm wondering if one of the subsections I initially grouped under tools/resources/datasets might fit better down here.}
...
\paragraph{Advisory council.}
During the second year\clg{Fixme: call says meeting with advisory council every year (and we budgeted for it).} of the project, once there is enough input from
...
Call says (not specifically referencing this subsection, but later), two things: (1) ``Means by which infrastructure utilization and user satisfaction will be evaluated and used to refine and improve subsequent infrastructure operations;"
and (2) ``Community plans to provide long-term sustainability of the infrastructure;''

Claire thinks it might make sense to put that content IN this section, but specifically label the paragraphs in question so they're easy to find.
