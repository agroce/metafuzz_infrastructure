...
\begin{table}
  \begin{tabular}{|l|}
    \hline
    Thrust 1: Fundamental Infrastructure: Ensemble Fuzzing and
    Fuzzer Evaluation \\ Lead: UVA; Secondary: NAU (User / Ensemble
    Strategy DSL)\\
    \hline
    Thrust 2: Tools and Resources: Source and Binary Transformations \\ Lead: CMU (Le
    Goues); Secondary: NAU and UVA (Binary Transformations)\\
    \hline
    Thrust 3: Tools and Resources: Universalized Custom Mutators \\ Lead: NAU\\
    \hline
    Thrust 4: Tools and Resources: Domain-Specific Fuzzers
