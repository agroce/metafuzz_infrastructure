...
FuzzFactory~\cite{fuzzfactory} is a meta-fork \jdh{what is a meta-fork? reword} of AFL which enables researchers 
...
bugs \cite{cc2022}. \clg{others to cite?} These were implemented in a standalone variant of the 
...
\includegraphics[width=\textwidth]{bigpic.png}
%}

\caption{An overview of meta-fuzzing functionalities and how they 
  interact with a targeted fuzzer.}
\label{fig:meta}
\end{figure}
...
First, a thrust table, which I am now writing:
...
\begin{table}
 \begin{tabular}{|p{5cm}|p{10cm}|l|}
   ...
   \hline
   \hline
    Thrust 2: Source and Binary Transformations & Lead: CMU (Le
    Goues); Secondary: NAU and UVA (Binary Transformations)\\
    \hline
    Thrust 3: Universalized Custom Mutators & Lead: NAU\\
    \hline
    Thrust 4: Domain-Specific Fuzzers
    (Cross-Cutting) & Lead: CMU (Padhye) \\
    \hline
    
  \end{tabular}
  \caption{\label {tab:thrusts} Project Thrusts and Core Responsibilties}
\end{table}
